...
class leaders_apprenant(models.Model):
    ...
    is_student = fields.Boolean("Etes vous un etudiant ?", defaut=False)
    ...
    year_id = fields.Many2one("leaders.year", string ="Année en cours",default=lambda self: self._get_default_academic_year())
    #
